            ...
            {tips.map((tip, i) => (
              <motion.div
                ...
                className={`rounded-2xl border overflow-hidden transition-all ${
                  openIndex === i ? "border-[#C41E8E]/30 bg-[#FDF8F5]" : "border-[#1C1412]/8 bg-white hover:border-[#C41E8E]/20"
                }`}
              >
                <button
                ...
                >
                  <span className={`font-serif font-semibold text-base leading-snug ${openIndex === i ? "text-[#C41E8E]" : "text-[#1C1412]"}`}>
                    {tip.question}
                  </span>
                  <ChevronDown
                    className={`h-5 w-5 shrink-0 text-[#C41E8E] transition-transform duration-300 ${openIndex === i ? "rotate-180" : ""}`}
                  />
                </button>
                <AnimatePresence initial={false}>
                  {openIndex === i && (
                    ...
                    >
                      <p className="px-6 pb-6 text-[#6B5B57] leading-relaxed text-sm">
                        {tip.answer}
                      </p>
                    </motion.div>
                  )}
